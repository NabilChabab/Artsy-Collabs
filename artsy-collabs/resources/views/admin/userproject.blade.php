                ...
                <div class="col-12">
                    <div class="card mb-4" style="background-color:#161718;">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center"
                            ...
                            <h6>Artists with Projects table</h6>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($userProjects as $user)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                  @foreach ($user->artProjects as $project)
                                                      <a href="#" class="status-badge" data-project-id="{{ $project->id }}" data-user-id="{{ $user->id }}">
                                                          @if ($project->pivot->response_status === 1)
                                                              <span class="badge badge-sm bg-gradient-success">Accepted</span>
                                                          @elseif ($project->pivot->response_status === 0)
                                                              <span class="badge badge-sm bg-gradient-warning">Pending</span>
                                                          @else
                                                              <span class="badge badge-sm bg-gradient-danger">Refused</span>    
                                                          @endif
                                                      </a>
                                                  @endforeach
                                              </td>
              ...
              <div class="modal-dialog">
                  <div class="modal-content" style="background-color: #161718">
                      ...
                      <div class="modal-body" style="background-color: #161718">
                        <form id="updateStatusForm" action="{{ route('userproject.update', ['userproject' => '__USER_PROJECT_ID__']) }}" method="POST">
                          @csrf
                          @method('PUT')
