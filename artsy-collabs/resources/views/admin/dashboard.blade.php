    ...
    <main class="main-content position-relative border-radius-lg ">
        ...
        <div class="container-fluid py-4">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            ...
                                            <p class="mb-0">
                                                <span
                                                    class="text-success text-sm font-weight-bolder">{{ $user->role->name }}</span>
            ...
            <div class="row mt-4">
                    ...
                    <div class="card " style="background-color:#161718;">
                        <div class="card-header pb-0 p-3" style="background-color:#161718;">
                            <div class="d-flex justify-content-between">
                                <h6 class="mb-2">Latest Projects</h6>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    ...
                                                    <h6 class="text-sm mb-0"><span class="text-success">$ </span>{{ $project->budget }}</h6>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">Start_Date</p>
                                                    <h6 class="text-sm mb-0">{{ $project->start_date }}</h6>
                                                </div>
                                            </td>
                                            <td class="align-middle text-sm">
                                                <div class="col text-center">
                                                    <p class="text-xs font-weight-bold mb-0">End_Date</p>
                                                    <h6 class="text-sm mb-0">{{ $project->end_date }}</h6>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                ...
                <div class="col-lg-5">
                    <div class="card" style="background-color:#161718;">
                        <div class="card-header pb-0 p-3 d-flex justify-content-between align-items-center" style="background-color:#161718;">
                        ...
                        <div class="card-body p-3" style="background-color:#161718;">
                            <ul class="list-group">
                                @foreach ($partners as $partner)
                                    @if ($partner->artProjects->isNotEmpty())
                                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg" style="background-color:#161718;">
                                            <div class="d-flex align-items-center">
                                                <div class="icon icon-shape icon-sm me-3 bg-gradient-dark shadow text-center">
                                                    <img src="{{ $partner->getFirstMediaUrl('images') }}" alt="" style="width: 40px;height:40px;border-radius:10px;">
                                                </div>
                                            ...
                                            <div class="d-flex">
                                                @foreach($partner->artProjects as $artProject)
                                                    <a href="#"><img src="{{$artProject->getFirstMediaUrl('images')}}"  style="width: 40px;height:40px;border-radius:10px;"></a>
                                                @endforeach
                                            </div>
                                        </li>
                                    @endif
