              ...
              <div class="row">
                <div class="col-8" >
                  <div class="numbers">
                    ...
                    <p class="mb-0">
                      <span class="text-success text-sm font-weight-bolder">{{$user->role->name}}</span>
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow-primary text-center rounded-circle">
                    <img src="{{$user->getFirstMediaUrl('images')}}" alt="" srcset="" class="icon icon-shape bg-gradient-primary shadow-primary text-center rounded-circle" >
                  </div>
                </div>
              </div>
            </div>
