    ...
    <main class="main-content position-relative border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4" style="background-color:#161718;">
                        <div class="card-header pb-0" style="background-color:#161718;">
                            <h6>Authors table</h6>
                        </div>
                                        ...
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <span
                                                        class="badge badge-sm bg-gradient-success">{{ $user->role->name }}</span>
                                                </td>
            ...
            <div class="modal fade" id="assignProjectModal" tabindex="-1" aria-labelledby="assignProjectModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" style="bottom: 30%;">
                    <div class="modal-content" style="background-color:#161718">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="{{ route('userproject.store') }}" class="p-2">
                                @csrf
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <button type="submit" name="project_id" value="{{ $project->id }}"
                                                ...
                                                <img src="{{ $project->getFirstMediaUrl('images') }}" alt=""
                                                    class="img-fluid rounded" style="width: 100px;height:70px;object-fit:center;">
                                            </button>
                                        </div>
                                    @endforeach
                                </div>
